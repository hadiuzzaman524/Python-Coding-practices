...
print("")
print("\u001b[44;1m\u001b[31mWelcome to tic tac toe..!\u001b[0m")
drowBoard()
count=0
userinput=[]
...
while count<np.sqrt(9):
    count+=1
    x=input("\u001b[44;1m\u001b[31mPlease choose your favorite number between(1-9):\u001b[0m ")
    while int(x) in userinput:
        x=input("\u001b[44;1m\u001b[31mAlready used please choose another one:\u001b[0m ")
...
if((board[0][0]==name and board[0][1]==name and board[0][2]==name) or
    ...
    print("\u001b[42;1m\u001b[31mCongratulations! You win 😊 \u001b[0m")
else:
    print("\u001b[41;1mYou loose 😢 \u001b[0m")
